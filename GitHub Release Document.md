# Plumbers App — Unified SQL Express & SQL Server Edition
## Initial GitHub Release — Version 1.0.0

This release introduces the fully unified version of the Plumbers App, combining all features and license tiers into a single Windows `.exe` application. The app supports both SQL Express and SQL Server, selected during installation, eliminating the need for separate builds or database versions.
...
### Basic Plan
Provides essential management features for individuals or small teams in the plumbing industry.  
...
## Database
The Plumbers App supports two database modes, selected during installation:
